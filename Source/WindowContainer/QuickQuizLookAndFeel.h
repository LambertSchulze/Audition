...
class QuickQuizLookAndFeel : public LookAndFeel_V4
{
public:
    QuickQuizLookAndFeel()
    {
                               ...
                               bool isMouseOverButton, bool isButtonDown) override
    {
        ...
        {
            //draw outline
            g.setColour (AuditionColours::black);
            g.drawRect(buttonArea.reduced(radius + outlineThickness/2), outlineThickness);
            //fill background
            g.setColour (backgroundColour);
            g.fillRect(buttonArea.reduced(radius + outlineThickness));
        }
    };
